  ...
  return (
    <section className="relative isolate overflow-hidden bg-ink px-5 pb-16 pt-28 sm:pb-24 sm:pt-32">
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        {/* Book A Call CTA */}
        <div className={`${rise(stage >= 5)} mt-6`}>
          <a
            href="https://api.leadconnectorhq.com/widget/booking/XHmJCxFl4NB4MKGUNiqC"
            target="_blank"
            rel="noopener"
            className="group inline-flex min-h-[44px] items-center justify-center gap-2 rounded-full bg-primary px-7 py-3 text-sm font-bold tracking-tight text-primary-foreground shadow-[0_16px_40px_-14px_color-mix(in_oklab,var(--color-primary)_70%,transparent)] transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-0.5 hover:brightness-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
            Book A Call
