...
const reviews: Review[] = [
  ...
  { img: r3.url, rot: -3, mRot: -2, z: 40, pos: "sm:absolute sm:left-1/2 sm:top-[92px] sm:w-[300px] sm:-translate-x-1/2", focal: true },
  { img: r4.url, rot: 4, mRot: 2, z: 30, pos: "sm:absolute sm:left-2 sm:bottom-0 sm:w-[255px]" },
  { img: r5.url, rot: -5, mRot: -2.5, z: 25, pos: "sm:absolute sm:right-4 sm:bottom-2 sm:w-[250px]" },
];
  ...
  return (
    <section className="relative overflow-hidden bg-ink px-5 py-16 sm:py-24">
      ...
      <div className="relative mx-auto mt-10 flex max-w-[820px] flex-col items-center sm:mt-14">
        ...
        <div
          ref={ref}
          className="relative mx-auto mt-6 flex w-full max-w-[340px] flex-col items-center gap-5 sm:mt-4 sm:block sm:h-[520px] sm:max-w-[800px]"
        >
          {reviews.map((rv, i) => (
            <figure
              key={i}
